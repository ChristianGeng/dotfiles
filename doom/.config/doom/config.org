...
This is my personal Doom Emacs config.
 Used the configuration by Derek Taylor aka [[https://gitlab.com/dwt1/dotfiles/-/tree/master/.config/doom][distrotube]] as a starter,
with gradually evolving such that it fits my personal needs.

I particular, these days Consult (with Vertico and Embark) is recommended,
and I am gradually transitioning to it.
 Unless you have a specific reason to stick with the older Ivy/Counsel system,
