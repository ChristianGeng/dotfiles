...
| =4= | [[elisp:(find-file (concat (getenv "HOME") "/.config/doom/cheatsheet.org"))][cheatsheet.org]] | Vim/Evil mode cheatsheet for quick reference.             |
| =5= | [[elisp:(find-file (concat (getenv "HOME") "/.config/doom/eshell/aliases"))][eshell/aliases]] | Aliases file for the eshell.                               |
| =6= | [[elisp:(find-file (concat (getenv "HOME") "/.config/doom/eshell/profile"))][eshell/profile]] | Profile for the eshell.                                    |
|---+----------------+------------------------------------------------------------|
